...
public class ArbeeFeatureRender extends FeatureRenderer<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> {
	Identifier identifier4 = new Identifier("addola:" + "capes/arbeecape.png");
	
	public ArbeeFeatureRender(FeatureRendererContext<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> featureRendererContext) {
